...
console.log(
	`  Uptime:           ${Math.round((health.uptime || 0) / 1000 / 60)} minutes (${Math.round((health.uptime || 0) / 1000 / 60 / 60)} hours)`,
);
...
if (newTraces.length > 0) {
	...
	console.log(
		`    Action: ${latest.enforcementAction === "none" ? "no action needed" : latest.enforcementAction}`,
	);
